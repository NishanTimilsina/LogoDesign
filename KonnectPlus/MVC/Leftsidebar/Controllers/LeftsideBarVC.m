...
@interface LeftsideBarVC ()

@end

@implementation LeftsideBarVC
@synthesize topItems,subItems;
- (void)viewDidLoad
{
    [super viewDidLoad];
   // [self getTopItem];
    topItems = [NSMutableArray arrayWithObjects:@"Egg Benedict", @"Mushroom Risotto", @"Full Breakfast", @"Hamburger", @"Ham and Egg Sandwich", @"Creme Brelee", @"White Chocolate Donut", @"Starbucks Coffee", @"Vegetable Curry", @"Instant Noodle with Egg", @"Noodle with BBQ Pork", @"Japanese Noodle with Pork", @"Green Tea", @"Thai Shrimp Cake", @"Angry Birds Cake", @"Ham and Cheese Panini", nil];
    self.tableView.delegate=self;
    self.tableView.dataSource=self;
   // self.apiArray=[[NSMutableArray alloc] init];
    ...
    subItems = [[NSMutableArray alloc]init];
     subItems = [NSMutableArray arrayWithObjects:@"Egg Benedict", @"Mushroom Risotto", @"Full Breakfast", @"Hamburger", @"Ham and Egg Sandwich", @"Creme Brelee", @"White Chocolate Donut", @"Starbucks Coffee", @"Vegetable Curry", @"Instant Noodle with Egg", @"Noodle with BBQ Pork", @"Japanese Noodle with Pork", @"Green Tea", @"Thai Shrimp Cake", @"Angry Birds Cake", @"Ham and Cheese Panini", nil];
    topItems = [NSMutableArray arrayWithObjects:@"one",@"two", nil];
    ...
    //self.ParentidVCArray=[[NSMutableArray alloc] init];
